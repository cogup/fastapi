...
function insertIncludeOnOpenAPISchemas(paths, resources) {
    ...
    Object.entries(resources).forEach(([key, value]) => {
        ...
        include.forEach((include) => {
            const includeProperties = getIncludeProperties(include.model.name, paths, resources);
...
function resolveNewOperation(get, properties, statusCode) {
    const responseOkRaw = get.responses[statusCode];
...
function getIncludeProperties(target, paths, resources) {
