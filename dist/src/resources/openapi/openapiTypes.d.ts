...
export interface Schema {
    ...
    properties?: {
        [property: string]: Schema | Reference;
    };
    ...
    patternProperties?: {
        [pattern: string]: Schema | Reference;
    };
...
export interface Operation {
    ...
    responses: Responses;
    callbacks?: {
        [callback: string]: Callback | Reference;
    };
    deprecated?: boolean;
    security?: SecurityRequirement[];
    servers?: Server[];
...
export interface Parameter {
    ...
    style?: 'matrix' | 'label' | 'form' | 'simple' | 'spaceDelimited' | 'pipeDelimited' | 'deep';
    explode?: boolean;
...
export interface Components {
    ...
    responses?: {
        [response: string]: Response | Reference;
    };
    parameters?: {
        [parameter: string]: Parameter | Reference;
    };
    examples?: {
        [example: string]: Example | Reference;
    };
