...
exports.convertToSingle = exports.convertToPlural = exports.convertOpenAPItoSchemas = exports.extractByMethod = void 0;
            ...
            if (method !== 'parameters') {
                ...
                parameters.forEach((parameter) => {
                    if (parameter.in === 'path' &&
                        ...
                        throw new Error(`Declared path parameter "${parameter.name}" needs to be defined as a path parameter at either the path or operation level`);
                    }
                });
            }
        }
