...
function getAll(resource) {
    return async (request, reply) => {
        try {
            ...
            (0, events_1.emitAction)(resource.model, HandlerType.GET_ALL, { request, error });
        }
    };
}
    ...
    return async (request, reply) => {
        try {
            ...
            reply
                .status(500)
                .send({ request, error: `Failed to fetch ${resource.name}.` });
            (0, events_1.emitAction)(resource.model, HandlerType.GET_ONE, { request, error });
        }
    };
}
...
function create(resource) {
    return async (request, reply) => {
        try {
            ...
            (0, events_1.emitAction)(resource.model, HandlerType.CREATE, { request, error });
        }
    };
}
...
function update(resource) {
    return async (request, reply) => {
        try {
            ...
            (0, events_1.emitAction)(resource.model, HandlerType.UPDATE, { request, error });
        }
    };
}
...
function remove(resource) {
    return async (request, reply) => {
        try {
            ...
            (0, events_1.emitAction)(resource.model, HandlerType.REMOVE, { request, error });
        }
    };
}
