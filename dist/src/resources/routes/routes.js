...
function getAll(resource) {
    return async (request, reply) => {
        try {
            ...
            (0, events_1.emitAction)(resource.model, HandlerType.GET_ALL, null, data);
        }
        catch (err) {
            reply.log.error(err);
...
function getOne(resource) {
    return async (request, reply) => {
        try {
            ...
            reply.send(data);
            (0, events_1.emitAction)(resource.model, HandlerType.GET_ONE, null, data);
        }
        catch (err) {
            reply.log.error(err);
            reply.status(500).send({ error: `Failed to fetch ${resource.name}.` });
...
function update(resource) {
    return async (request, reply) => {
        try {
            ...
            reply.send(data);
            (0, events_1.emitAction)(resource.model, HandlerType.UPDATE, null, data);
        }
        catch (err) {
            reply.log.error(err);
...
function remove(resource) {
    return async (request, reply) => {
        try {
            ...
            (0, events_1.emitAction)(resource.model, HandlerType.REMOVE, null, data);
        }
        catch (err) {
            reply.log.error(err);
