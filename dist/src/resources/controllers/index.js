...
exports.resolveResponses = exports.CreateRoutes = exports.RoutesBuilder = exports.PathBuilder = exports.routesToPaths = exports.HandlerMethodType = exports.MethodType = void 0;
...
var HandlerMethodType;
(function (HandlerMethodType) {
    HandlerMethodType["GET_ALL"] = "getAll";
    HandlerMethodType["GET_ONE"] = "getOne";
    HandlerMethodType["CREATE"] = "create";
    HandlerMethodType["UPDATE"] = "update";
    HandlerMethodType["REMOVE"] = "remove";
})(HandlerMethodType || (exports.HandlerMethodType = HandlerMethodType = {}));
...
function routesToPaths(controllers) {
    const paths = {};
...
class CreateRoutes {
    ...
    createRoutes(controllers) {
        Object.entries(controllers).forEach(([path, methods]) => {
    ...
    createRouteResource({ paths, resource, handlers, adminData }) {
        Object.entries(paths).forEach(([path, value]) => {
            ...
            Object.keys(innerOperation).forEach((method) => {
                ...
                const handler = this.getHandler(handlers, path, method, resource, operation, adminData);
    ...
    getHandler(handlers, path, method, resource, operation, adminData) {
    ...
    createRouteInner({ path, method, operation, handler }) {
        ...
        if (route.schema !== undefined && operation.requestBody !== undefined) {
            ...
            const schema = responseBody.content[mediaType].schema;
