...
import { Controllers, HandlerMethods, HandlerMethodType, Handlers, Methods, PathBuilder, Route, RoutesBuilder } from './resources/controllers';
import { Resource, Resources, Schema, SequelizeModel, SequelizeResources } from './resources/sequelize';
import { emit, emitAction, EventCallback, EventKey, on, onAction, remove, removeAction } from './resources/events';
...
export type RoutesType = Controllers | RoutesBuilder | PathBuilder | typeof Builder | Builder | BuilderInject;
