...
import { MakeHandlers, HandlerResourceTypes } from './decorators/handlers';
...
export { OnCreate, OnGetAll, OnGetOne, OnUpdate, OnRemove, OnEvent, MakeEvents } from './decorators/events';
