...
Object.defineProperty(exports, "HandlerMethodType", { enumerable: true, get: function () { return controllers_1.HandlerMethodType; } });
...
const openapi_2 = __importDefault(require("./controllers/openapi"));
...
const loader_1 = require("./controllers/loader");
...
class FastAPI {
    ...
    constructor(props) {
        ...
        (0, loader_1.loadControllers)(process.cwd()).forEach((controller) => {
    ...
    loadRoutes() {
        ...
        const createRoutes = new controllers_1.CreateRoutes(this.api);
        for (const key in this.resources) {
            const resource = resources[key];
            const openapiSchemas = (0, openapi_1.generateOpenAPISchemas)(resource, tags, this.prefix);
        ...
        schemasPaths = (0, openapi_1.insertIncludeOnOpenAPISchemas)(schemasPaths, resources, this.prefix);
        let paths = {};
        this.controllers.forEach((route) => {
            createRoutes.createRoutes({ ...route });
            paths = { ...paths, ...(0, controllers_1.routesToPaths)(route) };
        });
        const health = new health_1.default();
    ...
    addRoutes(routes) {
        if (routes instanceof controllers_1.RoutesBuilder || routes instanceof controllers_1.PathBuilder) {
...
var controllers_2 = require("./resources/controllers");
Object.defineProperty(exports, "PathBuilder", { enumerable: true, get: function () { return controllers_2.PathBuilder; } });
Object.defineProperty(exports, "RoutesBuilder", { enumerable: true, get: function () { return controllers_2.RoutesBuilder; } });
...
var routes_1 = require("./resources/controllers/routes");
Object.defineProperty(exports, "HandlerType", { enumerable: true, get: function () { return routes_1.HandlerType; } });
var routes_2 = require("./decorators/routes");
Object.defineProperty(exports, "Get", { enumerable: true, get: function () { return routes_2.Get; } });
Object.defineProperty(exports, "Post", { enumerable: true, get: function () { return routes_2.Post; } });
Object.defineProperty(exports, "Put", { enumerable: true, get: function () { return routes_2.Put; } });
Object.defineProperty(exports, "Patch", { enumerable: true, get: function () { return routes_2.Patch; } });
Object.defineProperty(exports, "Delete", { enumerable: true, get: function () { return routes_2.Delete; } });
