...
const events_2 = require("./decorators/events");
...
class FastAPI {
    ...
    afterLoadExecute() {
        if (this.afterLoad) {
            this.afterLoad.forEach((builder) => {
                builder.onLoad(this);
                if (builder instanceof events_2.MakeEvents) {
                    builder.loadEvents();
                }
            });
        }
    ...
    addEvents(events) {
        if (events instanceof events_2.MakeEvents) {
...
var events_3 = require("./decorators/events");
Object.defineProperty(exports, "OnCreate", { enumerable: true, get: function () { return events_3.OnCreate; } });
Object.defineProperty(exports, "OnGetAll", { enumerable: true, get: function () { return events_3.OnGetAll; } });
Object.defineProperty(exports, "OnGetOne", { enumerable: true, get: function () { return events_3.OnGetOne; } });
Object.defineProperty(exports, "OnUpdate", { enumerable: true, get: function () { return events_3.OnUpdate; } });
Object.defineProperty(exports, "OnRemove", { enumerable: true, get: function () { return events_3.OnRemove; } });
Object.defineProperty(exports, "OnEvent", { enumerable: true, get: function () { return events_3.OnEvent; } });
Object.defineProperty(exports, "MakeEvents", { enumerable: true, get: function () { return events_3.MakeEvents; } });
exports.events = {
    on: events_1.on,
    emit: events_1.emit,
