...
exports.modelName = exports.Decorators = exports.DataTypes = exports.HandlerMethodType = exports.log = exports.Model = exports.Sequelize = exports.ColumnType = exports.TableBuilder = exports.AutoColumn = exports.SchemaBuilder = exports.makeResponses = exports.RoutesBuilder = exports.PathBuilder = exports.FastAPI = void 0;
...
class FastAPI {
    ...
    addRoutes(routes) {
        if (routes instanceof routes_1.RoutesBuilder || routes instanceof routes_1.PathBuilder) {
            ...
            if (routes instanceof makes_1.MakeRouters) {
